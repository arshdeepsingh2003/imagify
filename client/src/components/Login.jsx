      ...
      >
        ...
        {state !== 'Login' && (
          <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-5'>
            <img src={assets.usersolid} alt="" />
            <input type='text' placeholder='Full Name' className='outline-none text-sm w-full' required />
          </div>
        )}

        <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-5'>
          <img src={assets.email_icon} alt="" />
          <input type='email' placeholder='Email-Id' className='outline-none text-sm w-full' required />
        </div>

        <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-5'>
          <img src={assets.lock_icon} alt="" />
          <input type='password' placeholder='Password' className='outline-none text-sm w-full' required />
        </div>
